...
// But if not specified any, use SPIFFS to not forcing user to install LITTLEFS library
  ...
  #warning Using LittleFS in BlynkSimpleEsp32_GSM_WFM.h
#elif USE_SPIFFS
  #include "FS.h"
  #include <SPIFFS.h>
  FS* filesystem =      &SPIFFS;
  #define FileFS        SPIFFS
  #warning Using SPIFFS in BlynkSimpleEsp32_GSM_WFM.h
#else
  #include <EEPROM.h>
  #warning Using EEPROM in BlynkSimpleEsp32_GSM_WFM.h
#endif
